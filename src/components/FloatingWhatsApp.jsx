        ...
        >
          ...
          <AnimatePresence>
            {showTooltip && (
              ...
              >
                <div className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white px-4 py-3 rounded-lg shadow-xl max-w-xs relative">
                  <button
                  ...
                  <div className="absolute bottom-0 right-8 transform translate-y-1/2 rotate-45 w-3 h-3 bg-white dark:bg-gray-800" />
                </div>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <a
            ...
            className="flex items-center justify-center w-16 h-16 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 group relative"
          ...
          >
            ...
            {/* Pulse animation */}
            <span className="absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-20 animate-ping -z-10" />
          </a>
        </motion.div>
      )}
    </AnimatePresence>
